...
var module = angular.module('helloworld', ['ui.router']);
...
module.config(function($stateProvider) {
   ...
   //     template: '<br><br><h1>uu</h1><div ng-controller="GreenCtrl"> <div ag-grid="gridOptions" class="ag-fresh" style="height: 100%;"></div></div>',
    ...
    var aboutState = {
        name: 'about',
        url: '/about',
       // template: '<br><br><h1>uu</h1><div ng-controller="RedCtrl"> <div ag-grid="gridOptions" class="ag-fresh" style="height: 100%;"></div></div>',
        template: '<h1>{{msg}}</h1>',
        controller: 'RedCtrl'
    }
...
module.controller("RedCtrl", function($scope) {
