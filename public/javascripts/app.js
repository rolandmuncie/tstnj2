...
module.controller("dssInputCtrl", function($scope) {
    var columnDefs = [{ headerName: "Trial Number", field: "TrialNumber",   minWidth: 120, pinned: true, cellStyle: {'background-color': 'Gainsboro'}, enableRowGroup: true},
        { headerName: "Thrptc Area Cdr", field: "ThrptcAreaCdr",   minWidth: 140,cellStyle: {'background-color': 'Gainsboro'},enableRowGroup: true },
        { headerName: "LY", field: "LY",  minWidth: 120, cellStyle: {'background-color': 'Gainsboro'},enableRowGroup: true },
        { headerName: "Trial Alias", field: "TrialAlias",  minWidth: 140, cellStyle: {'background-color': 'Gainsboro'},enableRowGroup: true },
        { headerName: "Cmpnd Desc", field: "CmpndDesc",  minWidth: 140, cellStyle: {'background-color': 'Gainsboro'},enableRowGroup: true },
